...
/**
 * Classe qui permet de faire le lien entre le fichier "make_a_coffee.feature"
 * et la classe implémentant les étapes
 * de test CoffeeMachineTestFunctionalTest.java
 */
@RunWith(Cucumber.class)
@CucumberOptions(features = { "classpath:functional/features/" }, glue = "fr.imt.coffee.machine.cucumber.steps")
