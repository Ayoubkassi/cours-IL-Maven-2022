...
public class ElectricalResistanceTest {
     ...
     * Permet d'éviter de recalculer ce temps dans chaque test et éviter les erreurs
     * humaines
     * 
    ...
    /**
     * Test permettant de vérifier le fonctionnement de la résistance électrique
     * dans un cas nominal avec JUnit
     * 
    ...
    public void testWaterHeatingNominalCaseWithJUnit() throws InterruptedException {
        ...
        // Assertion faite avec JUnit5 qui permet de vérifier que la valeur renvoyée par
        // la resistance est bien égale
        // à l'attendue.
    ...
    /**
     * Test permettant de vérifier le fonctionnement de la résistance électrique
     * dans un cas nominal avec Hamcrest
     * 
     * @throws InterruptedException
     */
    @Test
    public void testWaterHeatingNominalCaseWithHamcrest() throws InterruptedException {
        ...
        // Assertion faite avec Hamcrest. Hamcrest permet comme JUnit de faire des
        // assertions.
        // Il est parfois préféré car Hamcrest dispose de plus de fonction d'assertion
        // que JUnit 5 notamment sur les listes.
