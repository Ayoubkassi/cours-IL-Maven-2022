...
public class MainCoffee {
    ...
    // Instantiation of the logger using LogManager.
    // Specifying the name of the class that will produce logs.
    // The logger allows logging at different levels: INFO, WARNING, DEBUG, ERROR...
    ...
    public static void main(String[] args) {
        ...
        CoffeeMachine coffeeMachine = new CoffeeMachine(0.20, 3,
                0.20, 3, 600);
        ...
        try {
            ...
            // On se doit d'éviter de printer la stackTrace directement dans un
            // system.out.[..].
            // Risque potentiel d'exploitation malveillante de la trace via une remontée
            // directe dans la console/interface web.
            // e.printStackTrace();
